  ...
  return (
    ...
    <Navbar></Navbar>
      <div className="py-12">
        ...
        <div className="hidden pe-40  sm:flex flex-col justify-start items-start ">
            ...
            <div className="border-gray-200 border-b pb-10">
              ...
              <div className="px-4 mt-6 flex justify-between w-full  jusitfy-center items-center">
                <div>
                  <a
                    href="javascript:void(0)"
                    className="hover:underline text-base font-medium leading-none focus:outline-none focus:underline text-gray-800 dark:text-white"
                  >
                    {" "}
                    View details
                  </a>
